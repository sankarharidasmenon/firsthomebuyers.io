...
export default function AskAISection() {
  ...
  return (
    <section id="ai-guidance" className="bg-background pt-2 pb-4 lg:pb-6 scroll-mt-20 lg:scroll-mt-24">
      <ScrollReveal className="max-w-[1150px] mx-auto px-4 lg:px-4">

        {/* Section header */}
        <div className="text-center mb-6">
          {/* <div className="inline-flex items-center gap-2 bg-fn-yellow-light text-fn-navy text-xs font-bold px-4 py-1.5 rounded-full mb-2 uppercase tracking-widest">
