...
import { Home, Mail, Newspaper, MessageSquare, Map, Menu, X, Cpu, Sparkles, Library, Calculator } from 'lucide-react'
...
const ICON_LINKS = [
  ...
  { href: '/schemes/calculator', label: 'All-States Calculator', Icon: Calculator },
