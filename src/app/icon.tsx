...
export default function Icon() {
  return new ImageResponse(
    (
      ...
      >
        {/* We scale the SVG to fit the 32x32 container while keeping it centered */}
        <svg width="32" height="17" viewBox="2 6 41 21.5" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
